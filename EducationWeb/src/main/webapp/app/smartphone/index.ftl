...
<html>
<head>
<title>Erudite for Iphone, Android &nbsp; Smartphone Mobile Website Template | Home : w3layouts</title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="The free Erudite Iphone web template, Andriod web template, Smartphone web template, free webdesigns for Nokia, Samsung, LG, SonyErricsson, Motorola web design" />
...
<div class="wrapper">
	<div class="main">
			<div class="grid_1_of_2 images_1_of_2">
				<h4>Lorem Ipsum is simply <span>dummy text of the</span> ornare vulputate printing</h4>
			<div class="grid_1_of_2 images_1_of_2 img_style">
				<img src="./images/pic1.jpg" alt="">
			</div>
				<p class="para top">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. </p>
				<div class="button1">
