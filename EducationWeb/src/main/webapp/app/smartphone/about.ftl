...
<html>
<head>
<title>Erudite for Iphone, Android &nbsp; Smartphone Mobile Website Template | About : w3layouts</title>
...
<div class="wrapper">
	<div class="main1">
			...
			<div class="grid_1_of_2 images_1_of_2 img_style">
				...
				<p class="para top">If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. </p>
				<div class="button1">
