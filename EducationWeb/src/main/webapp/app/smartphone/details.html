...
<html>
<head>
<title>Erudite for Iphone, Android &nbsp; Smartphone Mobile Website Template | Details : w3layouts</title>
...
<div class="main">
		<div class="details">
			<h2 class="style">Lorem ipsum dolor</h2>
		<div class="det_pic img_style">
			<img src="./images/det-pic.jpg" alt="">		
		</div>
		<div class="det-para">
			<p class="top para"> Duis aute irure dolor Lorem  Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </p>
			<div class="button1">
