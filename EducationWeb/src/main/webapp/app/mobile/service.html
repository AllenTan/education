...
<html>
<head>
<title>Erudite webtemplate for high end mobiles, like samsung, nokia, lg, sony erricosn, htc mobile website templates for free | Services :: w3layouts</title>
...
<div class="main">
	<div class="ser-main">
		...
		<div class="ser-grid-list img_style">
			<div class="gallery">
				<a href="details.html"><img src="./images/ser_pic1.jpg" title="image-name"></a>
			</div>
		...
		<div class="ser-grid-list img_style">
			<div class="gallery">
				<a href="details.html"><img src="./images/ser_pic2.jpg" title="image-name"></a>
			</div>
		...
		<div class="ser-grid-list img_style">
			<div class="gallery">
				<a href="details.html"><img src="./images/ser_pic3.jpg" title="image-name"></a>
			</div>
				<h5>pellentesque at ultrices</h5>
		...
		<div class="ser-grid-list img_style">
			<div class="gallery">
				<a href="details.html"><img src="./images/ser_pic4.jpg" title="image-name"></a>
			</div>
			<h5> Nunc easi diam risus</h5>
			<p class="para">Qsi turpis, pellentesque at ultrices in, dapibus in magna. Nunc easi diam risus, placerat ut scelerisque etplacet scelerisque ,Nunc easi diam risus, placerat ut scelerisque et, </p>
			<div class="button1">
