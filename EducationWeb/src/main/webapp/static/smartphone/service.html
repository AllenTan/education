...
<html>
<head>
<title>Erudite for Iphone, Android &nbsp; Smartphone Mobile Website Template | Services : w3layouts</title>
...
<div class="main">
	<div class="ser-main">
		...
		<div class="ser-para">
			<p class="para"> The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English.  </p>
		</div>
